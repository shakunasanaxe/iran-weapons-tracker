...
function initCharts() {
  ...
  if (usCtx) {
    new Chart(usCtx, {
      type: 'bar',
      data: {
        labels: ['Feb 28', 'Mar 1', 'Mar 2', 'Mar 3', 'Mar 4', 'Mar 5-7', 'Mar 8-10', 'Mar 11-14', 'Mar 15-17', 'Mar 18-20', 'Mar 21-24', 'Mar 25-28'],
        datasets: [{
          label: 'Air Sorties',
          data: [500, 600, 550, 450, 500, 1200, 900, 1000, 800, 900, 750, 700],
          backgroundColor: 'rgba(21,101,192,0.8)',
          borderRadius: 3,
        }, {
          label: 'Targets Struck',
          data: [750, 400, 300, 350, 300, 800, 600, 700, 500, 550, 450, 400],
          backgroundColor: 'rgba(30,136,229,0.6)',
          borderRadius: 3,
        }, {
          label: 'Ships Destroyed',
          data: [0, 0, 0, 18, 20, 16, 5, 3, 2, 0, 0, 0],
  ...
  if (launcherCtx) {
    new Chart(launcherCtx, {
      type: 'line',
      data: {
        labels: ['Feb 28', 'Mar 2', 'Mar 5', 'Mar 7', 'Mar 10', 'Mar 14', 'Mar 17', 'Mar 19', 'Mar 22', 'Mar 24', 'Mar 28'],
        datasets: [{
          label: 'Active Launchers',
          data: [430, 380, 320, 270, 210, 150, 140, 130, 120, 115, 105],
          borderColor: '#e63946',
          backgroundColor: 'rgba(230,57,70,0.1)',
          fill: true, tension: 0.3, pointRadius: 5,
        }, {
          label: 'Destroyed/Ineffective',
          data: [0, 50, 110, 160, 220, 280, 290, 300, 310, 315, 325],
          borderColor: '#2a9d8f',
